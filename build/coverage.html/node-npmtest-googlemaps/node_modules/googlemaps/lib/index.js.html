...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-googlemaps/node_modules/googlemaps/lib/index.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    <h1 style="font-weight: bold;">
        <a href="https://github.com/npmtest/node-npmtest-googlemaps">npmtest-googlemaps (v0.0.1)</a>
    </h1>
    <h1>Code coverage report for <span class="entity">node-npmtest-googlemaps/node_modules/googlemaps/lib/index.js</span></h1>
    <h2>
        
        Statements: <span class="metric">32.63% <small>(31 / 95)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        ...
        Lines: <span class="metric">32.63% <small>(31 / 95)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-googlemaps/node_modules/googlemaps/lib/</a> &#187; index.js</div>
</div>
<div class="body">
 ...
 * Constructor
 */
var GoogleMapsAPI = <span class="fstat-no" title="function not covered" >function(config, request) {</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  var pk = null;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (!check.object(config)) {</span>
<span class="cstat-no" title="statement not covered" >    config = {};</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  var clonedConfig = JSON.parse(JSON.stringify(config));</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (clonedConfig['google_private_key'] != null) {</span>
<span class="cstat-no" title="statement not covered" >    pk = clonedConfig['google_private_key'];</span>
<span class="cstat-no" title="statement not covered" >    delete clonedConfig['google_private_key'];</span>
  }
&nbsp;
  /**
   * Calling _getDefaultConfig() inside the constructor ensure the config is not a singleton
   */
<span class="cstat-no" title="statement not covered" >  this.config = _assignParams(_getDefaultConfig(), clonedConfig, ACCEPTED_CONFIG_KEYS);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (pk != null) {</span>
<span class="cstat-no" title="statement not covered" >    this.config['google_private_key'] = pk;</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (typeof request !== 'function') {</span>
<span class="cstat-no" title="statement not covered" >    request = defaultRequest;</span>
  }
&nbsp;
 ...
 */
GoogleMapsAPI.prototype.elevationFromPath = <span class="fstat-no" title="function not covered" >function(params, callback) {</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  return _elevationFromPath(this.request, this.config, params.path, params.samples, callback);</span>
&nbsp;
};
&nbsp;
&nbsp;
 ...
 */
GoogleMapsAPI.prototype.checkAndConvertArrayOfPoints = checkAndConvertPoint = <span class="fstat-no" title="function not covered" >function(input) {</span>
<span class="cstat-no" title="statement not covered" >  if ('string' === typeof input) {</span>
...
<span class="cstat-no" title="statement not covered" >      output.push(checkAndConvertPoint(input[i]));</span>
    }
<span class="cstat-no" title="statement not covered" >    return output.join('|');</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  throw new Error('Unrecognized input: checkAndConvertArrayOfPoints accepts Arrays and Strings');</span>
};
&nbsp;
&nbsp;
/**
 ...
 */
GoogleMapsAPI.prototype.checkAndConvertPoint = <span class="fstat-no" title="function not covered" >function(input) {</span>
<span class="cstat-no" title="statement not covered" >  if ('string' === typeof input) {</span>
<span class="cstat-no" title="statement not covered" >    return input;</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (Array.isArray(input)) {</span>
<span class="cstat-no" title="statement not covered" >    return input[0].toString() + ',' + input[1].toString();</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  throw new Error('Unrecognized input: checkAndConvertPoint accepts Arrays of Numbers and Strings');</span>
};
&nbsp;
&nbsp;
...
var _elevationFromPath = <span class="fstat-no" title="function not covered" >function(request, config, path, samples, callback, sensor) {</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  var MAX_PATH_LENGTH = 1500;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (config.encode_polylines === true) {</span>
<span class="cstat-no" title="statement not covered" >    path = 'enc:' + _encodePolyline(path);</span>
  }
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >  var count = (path.length &lt; MAX_PATH_LENGTH ? 1 : Math.ceil(path.length/MAX_PATH_LENGTH));</span>
&nbsp;
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (count === 1) {</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    _makeRequest(request, config, GOOGLEMAPS_ENDPOINTS['elevation'], args, _jsonParser(callback), MAX_REQUEST_LENGTHS['elevation']);</span>
&nbsp;
  } else {
&nbsp;
<span class="cstat-no" title="statement not covered" >    var done = waitress(count, <span class="fstat-no" title="function not covered" >function(err, results) {</span></span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >      results = results</span>
        .sort(<span class="fstat-no" title="function not covered" >function(a, b) {</span> <span class="cstat-no" title="statement not covered" >return a.n - b.n; </span>})
        .map(<span class="fstat-no" title="function not covered" >function(v) {</span> <span class="cstat-no" title="statement not covered" >return v.results; </span>});
&nbsp;
<span class="cstat-no" title="statement not covered" >      var status = 'OK';</span>
<span class="cstat-no" title="statement not covered" >      var aggregated = [];</span>
...
<span class="cstat-no" title="statement not covered" >        aggregated = aggregated.concat(result.results);</span>
<span class="cstat-no" title="statement not covered" >        if (result.status !== 'OK') {</span>
...
<span class="cstat-no" title="statement not covered" >    var pieceSize = Math.ceil(path.length / count);</span>
...
<span class="cstat-no" title="statement not covered" >      var smallerPath = path.splice(0, pieceSize);</span>
&nbsp;
      // google will throttle us if we launch all the requests together, so we have to stagger them.
<span class="cstat-no" title="statement not covered" >      (<span class="fstat-no" title="function not covered" >function(n, path) {</span></span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        var samples = path.length;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        path = path.join('|');</span>
<span class="cstat-no" title="statement not covered" >        var cb = <span class="fstat-no" title="function not covered" >function(err, results) {</span></span>
<span class="cstat-no" title="statement not covered" >          if (err) {</span>
<span class="cstat-no" title="statement not covered" >            return done(err);</span>
          }
&nbsp;
<span class="cstat-no" title="statement not covered" >          return done(null, { n: n, results: results });</span>
        };
&nbsp;
...
<span class="cstat-no" title="statement not covered" >          _elevationFromPath(request, config, path, samples, cb, sensor);</span>
...
<div class="footer">
    <div class="meta">Generated by <a href="https://github.com/kaizhu256/node-utility2" target="_blank">utility2</a> at Thu Apr 20 2017 18:07:35 GMT+0000 (UTC)</div>
</div>
</body>
</html>
